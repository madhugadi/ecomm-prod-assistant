...
class DataIngestion:
    ...
    def _load_env_variables(self):
        ...
        # Add .strip() to remove any whitespace or newlines
        ...
        # Debug: Print to verify (remove after fixing)
        print(f"DB Endpoint: '{self.db_api_endpoint}'")
        print(f"DB Endpoint length: {len(self.db_api_endpoint)}")
